...
ALTER TABLE "site_settings" ALTER COLUMN "bank_name" SET DEFAULT 'Online Banking';--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "is_manager" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "assigned_manager_id" text;--> statement-breakpoint
